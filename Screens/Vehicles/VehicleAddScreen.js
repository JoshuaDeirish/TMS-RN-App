      ...
      <TwoColumnLayout
        ...
        rightContent={
          <>
            {activeTab === "details" && (
              <View>
                <TextInput style={input.input} placeholder="Vehicle ID" />
                <TextInput style={input.input} placeholder="License Plate" />
                <TextInput style={input.input} placeholder="Model" />
                <TextInput style={input.input} placeholder="Year" />
              </View>
            )}
